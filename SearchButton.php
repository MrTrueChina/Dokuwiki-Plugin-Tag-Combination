...
namespace dokuwiki\plugin\tagcombination;
...
class SearchButton extends AbstractItem
{
    ...
    protected $type = 'plugin_tagcombination__showsearchpage';
    // 图标路径，使用的是 svg 图标
    ...
    public function getLabel()
    {
        ...
        return plugin_load('action', 'tagcombination')->getLang('searchPageButtonTitle');
    }
}
